...
- V2.1g defines the current memory benchmark gate: `pnpm harness:memory-benchmark` is fixture-driven and now covers long-chat summary traceability, deterministic atom extraction, atom recall, source visibility, disabled/noise rejection, false-positive rejection, prompt budget skips, and explicit low-score gaps for calendar recall, source-passage drilldown, scene proactive recall, LLM extraction, and atom-level Memory Library controls. The current locked fixture baselines are `summaryRegressionScore: 1`, `recallRegressionScore: 1`, `atomExtractionScore: 0.82`, `atomRecallScore: 0.61`, `productReadinessScore: 0.27`, and `v21aScenarioScore: 0.2`; the current computed output is `atomExtractionScore: 0.825`, `atomRecallScore: 0.617`, `productReadiness.score: 0.277`, `capabilityScore: 0.311`, and `scenarioScore: 0.201`. CI fails below the recorded fixture baselines and uploads `.cache/greyfield-memory-benchmark/latest/summary.json`.
