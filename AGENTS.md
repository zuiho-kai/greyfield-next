...
- When debugging a PR after CI or review feedback, snapshot the current PR head, all check conclusions, unresolved review threads, and the latest bot review body before editing. Do not fix a failed job first and only later discover review-gate blockers, pending jobs, or stale review text.
